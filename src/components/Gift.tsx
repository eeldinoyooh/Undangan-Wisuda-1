  ...
  return (
    <section className="py-20 pt-0 px-4 bg-white relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        {/* <div className="mt-12 bg-[#1a202c] p-10 rounded-[3rem] border-4 border-white ring-1 ring-gray-200 shadow-2xl" data-aos="fade-up" data-aos-delay="200">
      ...
      {/* Wave Transition to RSVP (Dark Navy) */}
